...
<head>
    ...
    <meta name="author" content="hai_shar@yahoo.com">
    ...
    <link rel="stylesheet" href="{{ asset("website/assets/css/line-awesome.min.css") }}">
    <link rel="stylesheet" href="{{ asset("website/assets/css/animate.min.css") }}">
    <link rel="stylesheet" href="{{ asset("website/assets/owlcarousel/assets/owl.carousel.min.css") }}" />
...
<div class='c'>
    ...
    <div class='_2'>الصفحة غير موجودة</div>
    <a class='btn' href="/">الرجوع للرئيسية</a>
</div>
<!-- Optional JavaScript -->
<!-- jQuery first, then Popper.js, then Bootstrap JS -->
<script src="{{ asset("website/assets/js/jquery-3.1.1.min.js") }}" ></script>
<script src="{{ asset("website/assets/js/popper.min.js") }}"></script>
<script src="{{ asset("website/assets/js/bootstrap.min.js") }}"></script>
<script src="{{ asset("website/assets/js/wow.min.js") }}"></script>
<script src="{{ asset("website/assets/owlcarousel/owl.carousel.min.js") }}"></script>
